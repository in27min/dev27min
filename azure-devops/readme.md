...
```
aws configure
aws eks --region us-east-1 update-kubeconfig --name in27minutes-cluster 
kubectl get pods
kubectl get svc
...
```
az group create -l westeurope -n In27minutesK8sResourceGroup
az storage account create -n In27minutesK8sStorageAccount -g In27
minutesK8sResourceGroup -l westeurope --sku Standard_LRS
